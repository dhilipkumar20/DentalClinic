...
<body>
  ...
  <?php require_once("header.php");?>
    <div class="content-section" style="width:75%">
        ...
        {
            echo "<table><tr><th>ID</th><th>Clinic_Name</th><th>Location</th><th>Opening Hour</th><th>Closing Hour</th><th></th></tr>";
            while($row = mysqli_fetch_assoc($res))
            {
                ...
                $cl ="spllink";
                echo "<tr><td>".$id."</td><td>".$row['Clinic_Name']."</td><td>".$row['location']."</td><td>".$row['open_hr']."</td><td>".$row['close_hr']."</td><td><a class='nav__links' href='".$link."' class='".$cl."'>Check Dentists</a></td></tr>";
            }
        }
        else
